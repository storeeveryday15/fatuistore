  ...
  component: () => (
    <LegalPage
      ...
      sections={[
        ...
        { h: "4. How to request a refund", p: `Email ${CONTACT_EMAIL} or message us on WhatsApp within 7 days of the order, with your order ID and a brief description. Refunds are processed within 5 to 10 business days to the original payment method.` },
